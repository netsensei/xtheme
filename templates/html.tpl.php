...
<![if !IE]><html lang="<?php print $language->language; ?>" dir="<?php print $language->dir; ?>"<?php print $rdf_namespaces; ?>><![endif]>
  <head>
    ...
    <link rel="icon" type="imge/png" sizes="64x64" href="/img/icons/favicon.png">
    <link rel="icon" sizes="228x228" href="/img/icons/coast-icon-228x228.png">
    ...
    <meta name="msapplication-Tileimge" content="/img/icons/windows-tile-144x144.png">
